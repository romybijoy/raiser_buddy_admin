...
export const createProduct = createAsyncThunk(
  ...
  async (yourData, { rejectWithValue }) => {
    const {name, shortDesc, desc, images, price, quantity, categoryId} = yourData;
...
export const showProduct = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    ...
    response = await fetch(
          `${hostname}/product?pageNumber=${data.page}&pageSize=5`,
          {
            method: "GET",
            headers: {
...
export const showProductByKeyword = createAsyncThunk('showProductByKeyword', async (data, { rejectWithValue }) => {
